...
class ScrapingNiconico extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:scrapingNiconico';
    ...
    public function handle()
    {
        ...
        $crawler = $client->request('GET', 'https://www.nicovideo.jp/ranking/genre/all?term=24h');
